...
class Spotify
{
    ...
    function getToken(): void
    {
        ...
        try {
            ...
            // DEBUG: Log token acquisition attempt
            file_put_contents('debug_token_acquisition.txt', "Token URL: " . $this->token_url . '?' . http_build_query($params) . "\n", FILE_APPEND);
            file_put_contents('debug_token_acquisition.txt', "Token Headers: " . implode('\n', $headers) . "\n", FILE_APPEND);
            file_put_contents('debug_token_acquisition.txt', "Token Raw Result: " . $result . "\n", FILE_APPEND);
    ...
    function getLyrics($track_id): string
    {
        ...
        // DEBUG
        file_put_contents('debug_token.txt', "Token used: " . $token . "\n", FILE_APPEND);
        ...
        file_put_contents('debug_curl_response.txt', "Headers:\n" . $header . "\nBody:\n" . $body . "\n", FILE_APPEND);
